if not isfolder("Arc") then
    makefolder("Arc")
    makefolder("Arc/Assets")
    makefolder("Arc/Sound")
    makefolder("Arc/Sound/mc")
end

        --defining the UiLib
        local Rayfield = loadstring(game:HttpGet('https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/UiLib.lua'))()

        --loading menu
        local Window = Rayfield:CreateWindow({
            Name = "Arc",
            LoadingTitle = "Loading...",
            LoadingSubtitle = "notlevv#5594",
            ConfigurationSaving = {
                Enabled = true,
                FolderName = "Arc",
        ...
        local Notification = loadstring(game:HttpGet('https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/Notifs.lua'))()
        ...
        local array = loadstring(game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/ArrayList.lua"))()
        shared["CometConfigs"] = {
            Enabled = true
        }
        ...
        do
            ...
            local Enabled = false
            local Messages = {"Pow!","Asscrack!","Wham!","Hit!","Smack!","Bang!","Pop!","Boom!", "Haram!", "Pussy!", "Skuuuura!", "Ablam!", "Pha pha!", "Bitch!"}
            local old
            local DamageIndicatorst = Visuals:CreateToggle({
                Name = "CustomDamageIndicators",
                CurrentValue = false,
            ...
            local TexturePack = Visuals:CreateToggle({
                ...
                Callback = function(val)
                    ...
                    if Enabled then
                        ...
                        loadstring(game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/Textures.lua"))()
                    else
            ...
            local Scaffold = Blatant:CreateToggle({
                ...
                Callback = function(val)
                    ...
                    if Enabled then
                        ...
                        enabled("Scaffold", "Scaffold has been set to enabled!", 1)
                        spawn(function()
                            repeat
                                task.wait()
                                if isalive(lplr) then
                ...
                Callback = function(val)
                    ...
                    if Enabled then
                        ...
                        if lplr.leaderstats.Bed.Value ~= "✅" then
                            ...
                            writefile("Arc/Sound/mc/bedbroken.mp3",game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/bedbroken.mp3"))
                            sound.SoundId = getasset("Arc/Sound/mc/bedbroken.mp3") -- path to where ever the sound is in ur workspace
                            sound:Play()
                            wait(7)
                            sound:remove()
                        end
                        ...
                        spawn(function()
                            Client:WaitFor("BedwarsBedBreak"):andThen(function(p13)
                                p13:Connect(function(p14)
                                    local sound = Instance.new("Sound")
                                    sound.Parent = workspace
                                    writefile("Arc/Sound/mc/bedbreak.mp3",game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/bedbreak.mp3"))
                                    sound.SoundId = getasset("Arc/Sound/mc/bedbreak.mp3")-- path to where ever the sound is in ur workspace
                                    sound:Play()
                                    wait(4)
                                    sound:remove()
                                end)
                        ...
                        writefile("Arc/Sound/mc/pickup.mp3",game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/pickup.mp3"))
                        newsounds.PICKUP_ITEM_DROP = getasset("Arc/Sound/mc/pickup.mp3")
                        ...
                        writefile("Arc/Sound/mc/buyitem.mp3",game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/buyitem.mp3"))
                        newsounds.BEDWARS_PURCHASE_ITEM = getasset("Arc/Sound/mc/buyitem.mp3")
                        newsounds.STATIC_HIT = "rbxassetid://6361963422"
                        newsounds.STONE_BREAK = "rbxassetid://6496157434"
                        writefile("Arc/Sound/mc/woolbreak.mp3",game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/woolbreak.mp3"))
                        newsounds.WOOL_BREAK = getasset("Arc/Sound/mc/woolbreak.mp3")
                        writefile("Arc/Sound/mc/breakwood.mp3",game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/breakwood.mp3"))
                        newsounds.WOOD_BREAK = getasset("Arc/Sound/mc/breakwood.mp3")
                        writefile("Arc/Sound/mc/glassbreak.mp3",game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/glassbreak.mp3"))
                        newsounds.GLASS_BREAK = getasset("Arc/Sound/mc/glassbreak.mp3")
                        writefile("Arc/Sound/mc/tnthiss.mp3",game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/tnthiss.mp3"))
                        newsounds.TNT_HISS_1 = getasset("Arc/Sound/mc/tnthiss.mp3")
                        writefile("Arc/Sound/mc/tntexplode.mp3",game:HttpGet("https://raw.githubusercontent.com/AllahbloxLeaks/ArcAllahLeak/main/tntexplode.mp3"))
                        newsounds.TNT_EXPLODE_1 = getasset("Arc/Sound/mc/tntexplode.mp3")
                        gamesound = newsounds
                    else
